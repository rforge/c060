...
Stability selection is currently defined for gaussian, binomial, poisson, multinomial and cox models, interval search for ...., prediction error curves for cox models and classification errors for
