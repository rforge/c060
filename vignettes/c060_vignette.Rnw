...
\begin{figure}[H]
\begin{center}
<<glmnet, echo=T, results=hide, fig=T, height=4>>=
set.seed(1234)
...
\begin{figure}[t!]
\begin{center}
<<stabilitySelection3, echo=F, results=hide, fig=TRUE,height=7,width=7>>=
